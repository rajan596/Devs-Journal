...
- Useful for solving problems having Intervals
...
// Copied from LeetCode Editorial to illustrate how line sweep can be used...
```

- Reference : https://leetcode.com/problems/divide-intervals-into-minimum-number-of-groups/editorial/
